...
class Transformation {
  ...
  /// Returns [TransformationData].
  static TransformationData tBlur({double? sigma = 1, double? dpr = 1}) {
  ...
  static TransformationData bgExtend(
      {String? boundingBox,
      String? prompt = "",
      int? guidanceScale = 30,
      int? numberOfInferenceSteps = 50,
      int? seed = 123}) {
    return BgExtend().extend(
        boundingBox, prompt, guidanceScale, numberOfInferenceSteps, seed);
  }
