...
void main() {
  test('PixelBinImage Tests', () {
    ...
    image0.addTransformation(
        TransformationData(plugin: "sample", name: "sample"));
    image1.addTransformation(
        TransformationData(plugin: "sample", name: "sample"));
